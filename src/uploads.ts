...
function makeFile(fileBits: BlobPart[], fileName: string, options?: FilePropertyBag): FileLike {
  ...
  if (typeof File === 'undefined') {
    throw new Error(
      '`File` is not defined as a global which is required for file uploads; https://github.com/stainless-sdks/anthropic-typescript/tree/main#how-do-i-setup-file-uploads-in-nodejs',
    );
  }
