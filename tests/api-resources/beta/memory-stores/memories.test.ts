...
describe('resource memories', () => {
  test('create: only required params', async () => {
    const responsePromise = client.beta.memoryStores.memories.create('memory_store_id', { content: 'content', path: 'xx' });
  ...
  test('retrieve: only required params', async () => {
    const responsePromise = client.beta.memoryStores.memories.retrieve('memory_id', { memory_store_id: 'memory_store_id' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('update: only required params', async () => {
    const responsePromise = client.beta.memoryStores.memories.update('memory_id', { memory_store_id: 'memory_store_id' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.beta.memoryStores.memories.list('memory_store_id', {
    depth: 0,
    limit: 0,
    order: 'asc',
    order_by: 'order_by',
  ...
  test('delete: only required params', async () => {
    const responsePromise = client.beta.memoryStores.memories.delete('memory_id', { memory_store_id: 'memory_store_id' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
