...
describe('resource tunnels', () => {
  test('create', async () => {
    const responsePromise = client.beta.tunnels.create({});
  ...
  test('archive', async () => {
    const responsePromise = client.beta.tunnels.archive('tunnel_id');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('revealToken', async () => {
    const responsePromise = client.beta.tunnels.revealToken('tunnel_id');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('revealToken: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
  ...
  test('rotateToken', async () => {
    const responsePromise = client.beta.tunnels.rotateToken('tunnel_id', {});
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
