...
describe('resource versions', () => {
  test('create: only required params', async () => {
    const responsePromise = client.skills.versions.create('skill_id', {
  ...
  test('retrieve: only required params', async () => {
    const responsePromise = client.skills.versions.retrieve('version', { skill_id: 'skill_id' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('list', async () => {
    const responsePromise = client.skills.versions.list('skill_id');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('delete: only required params', async () => {
    const responsePromise = client.skills.versions.delete('version', { skill_id: 'skill_id' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
